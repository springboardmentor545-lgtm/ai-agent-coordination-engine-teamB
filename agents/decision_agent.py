...
decision_worker = Agent(
    ...
    system_instruction=(
        ...
        "automatic rejection. When explaining this, use the 'clean_days' and 'conflicting_days' "
        "fields to tell the employee EXACTLY which specific dates have the conflict and which "
        "don't, so they understand precisely what's causing the issue. If clean_days is not "
        "empty, mention that they could consider resubmitting for just those clean dates as "
        "an alternative while waiting for manager review on the conflicting days.\n"
