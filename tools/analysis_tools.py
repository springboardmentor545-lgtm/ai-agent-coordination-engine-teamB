...
def evaluate_leave_policy(
    ...
    All dates must be in YYYY-MM-DD format. Returns which rules passed or failed."""
    result = check_policy_rules(
        request_date, start_date, end_date, leave_balance, team_calendar, department_size
    )
